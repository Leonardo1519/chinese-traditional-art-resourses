  ...
  design: [
    {
      ...
      cover: 'assets/books/01-手工开悟-非遗与文创设计-cover.jpg',
      tags: ['非遗设计', '方法论', '理论指导'],
    },
    {
      name: '新时代文创产品设计',
      ...
      cover: 'assets/books/02-新时代文创产品设计-cover.jpg',
    ...
    },
    {
      ...
      cover: 'assets/books/03-文创地图-cover.jpg',
      tags: ['经营策略', '品牌塑造', '案例分析'],
    },
    {
      name: '书艺问道：吕敬人书籍设计说',
      ...
      cover: 'assets/books/15-书艺问道-cover.jpg',
      tags: ['书籍设计', '设计大师', '理念实践'],
    },
  ],
  ...
  craft: [
    {
      ...
      cover: 'assets/books/04-可爱手艺-和孩子一起学做100种中国古风手作-cover.jpg',
      tags: ['亲子美育', '古风手作', '传统工艺'],
    },
    {
      name: '华夏手工：图解传统手工制作',
      ...
      cover: 'assets/books/05-华夏手工-图解传统手工制作-cover.jpg',
      tags: ['图解教程', '传统工艺', '技法展示'],
    },
    {
      name: '趣玩：中国传统益智游戏',
      ...
      cover: 'assets/books/17-趣玩-中国传统益智游戏-cover.jpg',
      tags: ['益智游戏', '传统智慧', '文化趣味'],
    },
  ],
  ...
  typography: [
    {
      ...
      cover: 'assets/books/06-中国汉字设计史-cover.jpg',
      tags: ['汉字演变', '设计史学', '字体美学'],
    },
    {
      name: '上海字记',
      ...
      cover: 'assets/books/07-上海字记-cover.jpg',
      tags: ['城市字体', '视觉档案', '百年变迁'],
    },
    {
      ...
      cover: 'assets/books/08-旧物观察-中国早期商业设计中的文字造型与编排-cover.jpg',
      tags: ['商业设计', '版式编排', '视觉文化'],
    },
  ],
  ...
  folk: [
    {
      ...
      cover: 'assets/books/09-中国民间美术全集(丛书)-cover.jpg',
      tags: ['民间美术', '大型丛书', '艺术宝库'],
    },
    {
      name: '纹饰集：中国古代器物图案之美',
      ...
      cover: 'assets/books/10-纹饰集-中国古代器物图案之美-cover.jpg',
      tags: ['传统纹饰', '器物图案', '设计资源'],
    },
    {
      name: '古版年画丛谭',
      ...
      cover: 'assets/books/11-古版年画丛谭-cover.jpg',
      tags: ['年画艺术', '地域风格', '民间信仰'],
    },
    {
      name: '花间世界：库淑兰作品研究集',
      ...
      cover: 'assets/books/16-花间世界-库淑兰作品研究集-cover.jpg',
      tags: ['剪纸', '艺术家', '民间'],
    },
  ],
  ...
  culture: [
    {
      ...
      cover: 'assets/books/12-中国镇物-插图本-cover.jpg',
      tags: ['民俗研究', '辟邪文化', '图文并茂'],
    },
    {
      name: '中国祥物（插图本）',
      ...
      cover: 'assets/books/13-中国祥物-插图本-cover.jpg',
      tags: ['吉祥文化', '民俗符号', '祈福迎祥'],
    },
    {
      ...
      cover: 'assets/books/14-折纸针线包-鲜为人知的中国民间艺术-cover.jpg',
      tags: ['民间工艺', '实用美学', '巧思创意'],
    },
  ],
};
